...
class SategoriesSubScreen extends StatefulWidget {
  Map<String, String> initial_data;

  SategoriesSubScreen(this.initial_data);

  @override
  State<SategoriesSubScreen> createState() => ScategorieSsuSscreen(this.initial_data);
}
...
class ScategorieSsuSscreen extends State<SategoriesSubScreen> {
  Map<String, String> initial_data;

  ScategorieSsuSscreen(this.initial_data);
